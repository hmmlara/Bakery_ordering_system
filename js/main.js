...
(function ($) {
    ...
    proQty.on('click', '.qtybtn', function () {
        ...
        if ($button.hasClass('inc')) {
            ...
            // let subtotal =  parseInt(tr.find('#total').text());

            // subtotal += parseInt(tr.find('#unit_price').val());

            // tr.find('#total').text(subtotal);            

            // let main_total = 0;
            // totals.forEach(element => {
            //     main_total += parseInt(element.innerText);
            // });
