...
<div class="container-fluid">
            ...
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1"> <a href="order.php"
                                    style="text-decoration: none;"> Orders </a>
                            </div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                        <?php  echo $counteOrder['count_order']; ?></div>
                                </div>
                                <div class="col">
                                    <div class="progress progress-sm mr-2">
                                        <div class="progress-bar bg-info" role="progressbar"
                                            style="width: <?php echo $counteOrder['count_order'];?>%" aria-valuenow="50"
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                <a href="reports.php" style="text-decoration: none;"> Sales Report </a>
                            </div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php echo $totalAmountForOrder['SUM(order_details.subtotal)']; ?> MMK</div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                <a href="customize_report.php" style="text-decoration: none;"> Customize Sales
                                    Report</a>
                            </div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php echo $totalAmountForCustomizeOrder['SUM(customize_order_details.subtotal)']; ?>
                                MMK</div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                <a href="feedback.php" style="text-decoration: none;">FeedBakcs </a>
                            </div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php echo $countFeedbacks['count_id'] ?></div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="container mt-5">
        <form action="" method="post">
            <div class="row">
                <div class="col-md-6">
                    <select class="form-control" aria-label="Default select example" name="year" id='select' required>
