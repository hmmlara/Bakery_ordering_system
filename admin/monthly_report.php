...
$detail = $report_controller->getOrderDetail();
$years = $report_controller->getYear();

if(isset($_POST['confirm'])){
    if($_POST['month']){
        $month = $_POST['month'];
        $detail = $report_controller->byMonth($month);
    }
    if($_POST['year']){
        $year = $_POST['year'];
        $detail = $report_controller->byYear($year);
    }
    if($_POST['year'] && $_POST['month']){
        $month = $_POST['month'];
        $year = $_POST['year'];
        $detail = $report_controller->byYearMonth($year, $month);
    }
}
        ...
        <div class="container-fluid">
            ...
            <form action="" method="post">
                ...
                <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <button class="btn btn-success" name="confirm" type="submit"><i class="fa fa-paper-plane"></i>Confirm</button>
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-bodered" id="report_table_two">
                        <thead>
