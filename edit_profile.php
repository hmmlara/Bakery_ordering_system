...
$id=$_GET['id'];
$result=$userController->getUserForUpdate($id);
var_dump($result);
...
if(isset($_POST["update"]))
{
    ...
    if(!$error)
    { 
        $username=$userController->updateProfile($id,$new_name,$phone,$new_address,$email);       
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="" method="post">
                                        ...
                                        <div>
                                            <button type="submit" name="signup" class="btn btn-primary mt-3">Sign
                                                Up</button>
                                        </div>
